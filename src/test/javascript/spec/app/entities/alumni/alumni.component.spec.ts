...
import { AlumniComponent } from 'app/entities/alumni/alumni.component';
import { AlumniService } from 'app/entities/alumni/alumni.service';
import { Alumni } from 'app/shared/model/alumni.model';

describe('Component Tests', () => {
  describe('Alumni Management Component', () => {
    let comp: AlumniComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AlumniComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.alumni[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
