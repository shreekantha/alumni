...
@Component({
  ...
  templateUrl: './alumni-req-or-claim.component.html'
})
export class AlumniReqOrClaimComponent implements OnInit, OnDestroy {
  ...
  transition() {
    this.router.navigate(['/alumni-req-or-claim'], {
      queryParams: {
        page: this.page,
        size: this.itemsPerPage,
