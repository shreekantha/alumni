...
@Component({
  selector: 'jhi-fund-contribution',
  templateUrl: './fund-contribution.component.html'
})
export class FundContributionComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    ...
    let fundraiserId = this.fundraiserId != null ? this.fundraiserId : null
    this.fundContributionService
      .query({
        page: this.page - 1,
        size: this.itemsPerPage,
        sort: this.sort(),
        'contributor-id': AccountService.getUserId()
      })
