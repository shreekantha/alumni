...
export class DegreeComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.degreeService
      ...
      .subscribe((res: HttpResponse<IDegree[]>) => this.paginateDegrees(res.body, res.headers));
  }
  ...
  registerChangeInDegrees() {
    this.eventSubscriber = this.eventManager.subscribe('degreeListModification', () => this.loadAll());
  }
  ...
  protected paginateDegrees(data: IDegree[], headers: HttpHeaders) {
