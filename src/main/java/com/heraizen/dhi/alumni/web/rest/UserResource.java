...
import com.heraizen.dhi.alumni.service.MailService;
...
import com.heraizen.dhi.alumni.web.rest.errors.EmailAlreadyUsedException;
import com.heraizen.dhi.alumni.web.rest.errors.LoginAlreadyUsedException;
...
public class UserResource {
     ...
     */
    @GetMapping("/users")
    public ResponseEntity<List<UserDTO>> getAllUsers(@RequestParam(value="role", required=false)String role, Pageable pageable) {
       
	log.debug("getallusers {}",role);
	final Page<UserDTO> page = userService.getAllManagedUsers(role,pageable);
