...
/**
 * REST controller for managing {@link com.heraizen.dhi.alumni.domain.Degree}.
 */
@RestController
@RequestMapping("/api")
public class DegreeResource {
    ...
    public ResponseEntity<DegreeDTO> updateDegree(@RequestBody DegreeDTO degreeDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, degreeDTO.getId().toString()))
            .body(result);
    }
